...
const ContactsInfo = () => {
  return (
    <div className="mb-12 px-5 pt-3 sm:max-w-[570px] lg:mb-0">
      <span className="mb-4 block text-base font-semibold text-amber-500">
        Contacts
      </span>
      ...
      <div className="mb-8 flex w-full max-w-[370px] gap-3">
        <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary/5 text-amber-500 sm:h-[70px] sm:max-w-[70px]">
          <FaPhone size={24} />
        </div>
