      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-3 text-xl leading-7 text-gray-600 sm:mt-4">
            Here are list of the avaliables posts , sections and services in our
            website
          </p>
        </div>
      </div>
          ...
          <div className="relative mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl">
              <dl className="rounded-lg shadow-lg sm:grid sm:grid-cols-3">
                <div className="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r dark:border-gray-700">
                  <dt
                  ...
                  <dd
                    className="order-1 text-5xl font-extrabold leading-none text-amber-600"
                ...
                <div className="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l dark:border-gray-700">
                  <dt className="order-2 mt-2 text-lg font-medium leading-6 text-gray-500 dark:text-gray-400">
                    Services
                  </dt>
                  <dd
